...
<script>
    ...
    jQuery(document).ready(function($) {
        ...
        $('.add_to_cart_button').on('click', function(e) {
            ...
            // alert(`Custom click Product Id: ${product_id}`)
            console.log('Clicked!');
                        ...
                        if (row.length) {
                            ...
                            let newRow = `
                                <tr data-product-id="${data.productId}">
                                    ...
                                    <td><button class="delete" data-delete-id="${data.productId}"> Delete </button></td>
                                </tr>
                            `;
        ...
        $('.delete').on('click', function(e) {
            e.preventDefault();
            let productId = $(this).attr('data-delete-id');
            let $row = $(`tr[data-product-id="${productId}"]`);
                ...
                success: (response) => {
                    ...
                    if (response.success) {
                        ...
                        if ($row.length) {
                            ...
                            console.warn(`Row with product ID ${productId} not found in the table`);
                        }
                        ...
                        if (response.data && response.data.quantity !== undefined) {
                            ...
                            let $badge = $('.fa-shopping-cart').closest('.border').find('.badge');
                            if ($badge.length) {
                                $badge.text(current_items_in_cart);
                            ...
                            console.warn("Quantity data not found in the response");
                        }
